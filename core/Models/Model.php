<?php
	...
	class Model{
		...
		public static $dbName="realdata_RealDataSub"; //Database Name
		public static $username="realdata_RealDataSub"; // Database Username
		public static $password="Ekp3656@User"; //Database Password

        public static $dbh;
        
		public $emailUsername="admin@realdatasub.com.ng"; //Support Email Address
		public $emailPassword="realdata.P@20%"; //Support Email Password
