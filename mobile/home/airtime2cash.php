            ...
            <div class="content">
                ...
                <form method="post" class="airtimeForm" id="airtimeForm" action="buy-airtime">
                        <fieldset>
                            ...
                            <div class="input-style input-style-always-active has-borders mb-4">
                                <label for="networktype" class="color-theme opacity-80 font-700 font-12">Choose Payment Method</label>
                                <select id="networktype" name="networktype">
                            ...
                            <div class="input-style input-style-always-active has-borders validate-field mb-4">
                                ...
                                <input type="number" name="phone" placeholder="Enter Amount" value="" class="round-small" id="phone" required  />
                            </div>
