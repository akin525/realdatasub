...
<div class="list-group list-custom-small list-menu">
    ...
    <a href="fund-wallet">
        <i class="fa fa-plus color-white" style="background-color:<?php echo $sitecolor; ?>"></i>
...
<!--    </a>-->
    ...
    <a href="buy-airtime">
        <i class="fa fa-phone color-white" style="background-color:<?php echo $sitecolor; ?>"></i>
        <span>Airtime</span>
        <i class="fa fa-angle-right"></i>
    </a>
    <a href="transfer">
    ...
    <a href="notifications">
        <i class="fa fa-bell color-white" style="background-color:<?php echo $sitecolor; ?>"></i>
