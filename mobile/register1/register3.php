...
<div id="page">
    ...
    <div class="card">
            <div class="content">
                ...
                <div class="text-center">
                    <h1 class="font-30 mb-3 mt-3 text-dark">Register</h1>
                ...
                <div class="px-2">
                    ...
                    <a id="next-btn" style="width: 100%;" class="btn btn-full btn-l font-600 font-15 gradient-highlight mt-4 rounded-s" style="background-color: #F57F17;">
    Continue
</a>
                    ...
                    <div class="input-style  no-borders has-icon mb-4">
                        ...
                        <input type="number" value="" class="form-control" id="referal" readonly name="referal" placeholder="Referal" />
                    ...
                    <div class="row pt-3 mb-3">
                        <div class="col-12 text-center font-15 mt-2">
                            <a class="text-dark" href="../login/">Already Have An Account, <b>Login</b></a>
                        </div>
                    </div>
